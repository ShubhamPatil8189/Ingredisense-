    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-24 pb-20">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto animate-fade-in" style={{ animationDelay: "0.15s" }}>
        ...
        <div className="text-center animate-fade-in" style={{ animationDelay: "0.5s" }}>
          ...
          <button onClick={() => navigate("/")} className="inline-flex items-center gap-2 font-semibold text-foreground hover:text-primary transition-colors">
